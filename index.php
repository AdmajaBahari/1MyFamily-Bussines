<?php
$pageTitle = 'TOKO KAIN DAN ALAT JAHIT HASANAH - Lengkap & Terpercaya';
$activePage = 'home';
        ...
        <div class="hero-container">
            <div class="hero-content scroll-animate">
                ...
                <p class="hero-description">
                    Menyediakan berbagai macam kain berkualitas, alat jahit, dan aksesoris lengkap dengan harga terjangkau. Melayani penjahit pemula hingga profesional sejak tahun 2000.
                </p>
            ...
            <div class="hero-image scroll-animate">
                <img src="images/hero-store.jpg" alt="Interior Toko Kain Hasanah" loading="lazy">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="about-container">
            <div class="about-image scroll-animate">
                <img src="images/about-fabrics.jpg" alt="Koleksi Kain Toko Hasanah" loading="lazy">
            </div>
            <div class="about-content scroll-animate">
                <h2>Tentang Toko Hasanah</h2>
                <p>TOKO KAIN DAN ALAT JAHIT HASANAH telah melayani masyarakat Sragen dan sekitarnya sejak tahun 2019. Kami adalah toko keluarga yang berkomitmen menyediakan kebutuhan menjahit berkualitas dengan harga yang bersahabat.</p>
                <div class="about-values">
                    <div class="value-item"><div class="value-icon"><i class="fas fa-check"></i></div><span>Kualitas Premium</span></div>
                    <div class="value-item"><div class="value-icon"><i class="fas fa-check"></i></div><span>Harga Bersahabat</span></div>
                    <div class="value-item"><div class="value-icon"><i class="fas fa-check"></i></div><span>Pelayanan Terbaik</span></div>
                    <div class="value-item"><div class="value-icon"><i class="fas fa-check"></i></div><span>Komunitas Lokal</span></div>
                </div>
        ...
        <div class="products-grid">
            <div class="product-card scroll-animate">
                ...
                <div class="product-info">
                    <h3>Kain</h3>
                    <p>Berbagai jenis kain berkualitas premium dengan tekstur lembut dan nyaman dipakai</p>
            ...
            <div class="product-card scroll-animate">
                ...
                <div class="product-info">
                    ...
                    <span class="product-price">Mulai Rp 15.000/m</span>
                </div>
            </div>
            <div class="product-card scroll-animate">
                <div class="product-image">
                ...
                <div class="product-info">
                    ...
                    <span class="product-price">Mulai Rp 3.000</span>
                </div>
            </div>
            <div class="product-card scroll-animate">
                <div class="product-image">
                ...
                <div class="product-info">
                    ...
                    <span class="product-price">Mulai Rp 8.000</span>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="testimonials-grid">
            <div class="testimonial-card scroll-animate">
                ...
                <p class="testimonial-text">"Tokonya lengkap, bagus, dan harganya ramah"</p>
                <div class="testimonial-author">
                    <div class="author-avatar">BS</div>
                    <div class="author-info"><h4>Bu Siti</h4><span>Pelanggan</span></div>
                </div>
            </div>
            <div class="testimonial-card scroll-animate">
                <div class="testimonial-rating"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
                <p class="testimonial-text">"Bagus, Recommended banget!"</p>
                <div class="testimonial-author">
                    <div class="author-avatar">RA</div>
                    <div class="author-info"><h4>Rafi</h4><span>Penjahit Pemula</span></div>
                </div>
            </div>
            <div class="testimonial-card scroll-animate">
                ...
                <p class="testimonial-text">"Produk lengkap, dari kain sampai aksesoris kecil semua ada. Harga juga transparan dan bersaing."</p>
                <div class="testimonial-author">
                    <div class="author-avatar">RE</div>
                    <div class="author-info"><h4>Reza</h4><span>Pelanggan</span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="contact-container">
            <div class="contact-info scroll-animate">
                ...
                <div class="contact-details">
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-text"><h4>WhatsApp</h4><p>0812-1824-8892</p></div>
                    </div>
                    <div class="contact-item">
            ...
            <div class="contact-map scroll-animate">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3954.788503674058!2d110.9973105!3d-7.4431884!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a1ca9bff1cd7f%3A0xcba7f2d09bc4047c!2shasanah!5e0!3m2!1sen!2sid!4v1744000000000!5m2!1sen!2sid" allowfullscreen="" loading="lazy" title="Lokasi Toko Kain Hasanah"></iframe>
            </div>
        </div>
    </div>
</section>
